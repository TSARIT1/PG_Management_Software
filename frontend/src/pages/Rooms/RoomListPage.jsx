...
export default function RoomListPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 style={{ color: "white" }}>Room Management</h1>
          <p style={{ color: "rgba(255,255,255,0.9)" }}>
            Manage all hostel rooms and occupancy
          </p>
        </div>
      ...
      >
        ...
        >
          <div style={{ fontSize: '0.875rem', opacity: 0.9, marginBottom: '0.5rem' }}>Total Rooms</div>
        ...
        >
          <div style={{ fontSize: '0.875rem', opacity: 0.9, marginBottom: '0.5rem' }}>Available Rooms</div>
        ...
        >
          <div style={{ fontSize: '0.875rem', opacity: 0.9, marginBottom: '0.5rem' }}>Occupied Rooms</div>
          <div style={{ fontSize: '2rem', fontWeight: '700' }}>
        ...
        >
          <div style={{ fontSize: '0.875rem', opacity: 0.9, marginBottom: '0.5rem' }}>Total Beds</div>
          <div style={{ fontSize: '2rem', fontWeight: '700' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <div style={{ display: 'grid', gap: '1.5rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                    ...
                    <div>
                      <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: '600', color: '#6b7280', marginBottom: '0.5rem' }}>Type</label>
