    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
          ...
          <h1 className="page-title" style={{ color: 'white', margin: 0 }}>Attendance Report</h1>
        </div>
        <p className="page-subtitle" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
          Student attendance analytics and trends
        </p>
      </motion.div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
        ...
        >
          ...
          <div style={{ fontSize: '0.875rem', opacity: 0.9 }}>Average Attendance</div>
        </motion.div>
        ...
        >
          ...
          <div style={{ fontSize: '0.875rem', opacity: 0.9 }}>Total Present</div>
        </motion.div>
        ...
        >
          ...
          <div style={{ fontSize: '0.875rem', opacity: 0.9 }}>Total Absent</div>
        </motion.div>
      </div>
      ...
      >
        <div style={{ padding: '1.5rem', borderBottom: '1px solid #e5e7eb' }}>
          <h3 style={{ margin: 0, color: '#111827' }}>Student Attendance Details</h3>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead style={{ background: '#f9fafb', borderBottom: '2px solid #e5e7eb' }}>
                <tr>
                  ...
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: '#374151' }}>Total Days</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: '#374151' }}>Present</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: '#374151' }}>Absent</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: '#374151' }}>Percentage</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: '#374151' }}>Last Record</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    >
                      ...
                      <td style={{ padding: '1rem' }}>
                        {student.lastAttendance ? (
                          ...
                          <span style={{ fontSize: '0.875rem', color: '#6b7280' }}>No records</span>
                        )}
                      </td>
                    </motion.tr>
                  ))}
