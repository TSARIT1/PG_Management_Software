...
export default function StudentListPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 className="page-title" style={{ color: 'white' }}>Candidate Management</h1>
          <p className="page-subtitle" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>Manage all candidate records and information</p>
        </div>
          ...
          >
            ...
            >
              <h2 className="modal-title" style={{ color: 'white' }}>
                {editingStudent ? '✏️ Edit Candidate' : '➕ Add New Candidate'}
              </h2>
              <motion.button 
