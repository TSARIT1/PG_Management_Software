    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                System.err.println("JwtAuthenticationFilter - Token extraction failed: " + e.getMessage());
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtUtils.validateToken(token, userDetails)) {
                ...
                System.out.println("JwtAuthenticationFilter - Authentication successful for: " + username);
            } else {
                System.err.println("JwtAuthenticationFilter - Token validation failed for: " + username);
            }
        }
