...
public class AttendanceController {
    ...
    public ResponseEntity<?> markBulkAttendance(@RequestBody List<Attendance> attendanceList) {
        try {
            List<Attendance> savedAttendance = attendanceService.markBulkAttendance(attendanceList);
            Map<String, Object> response = new HashMap<>();
            response.put("status", "success");
    ...
    public ResponseEntity<?> getAttendanceByStudent(@PathVariable String studentName) {
        try {
            List<Attendance> attendance = attendanceService.getAttendanceByStudent(studentName);
            Map<String, Object> response = new HashMap<>();
            response.put("status", "success");
            response.put("data", attendance);
            return ResponseEntity.ok(response);
